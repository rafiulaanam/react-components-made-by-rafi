...
console.log(userError)
  ...
  return (
    ...
    bg-[#c13584]"
            ...
            <form onSubmit={handleSubmit(handleLogin)} className="flex flex-col justify-center items-center m-2 space-y-6 md:space-y-8">
              <div className="">
                <input
                {...register("email", {
                  required: true,
              ...
              <input type="submit" value="Sign In" className=" px-24 md:px-[118px] lg:px-[140px] py-2 rounded-md text-white bg-gradient-to-l from-blue-400 to-emerald-400  font-medium m-2 mb-6 uppercase"/>
          ...
          <div className="h-full w-full md:w-2/4  bg-gradient-to-l from-blue-400 to-emerald-400  items-center flex justify-center rounded-xl">
            <div className="text-black text-base font-semibold text-center my-10 space-y-2 m-2">
              ...
              <h1 className="text-5xl">Hello Friends</h1>
              <h1 className="py-8">
